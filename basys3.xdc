...
set_property PACKAGE_PIN P19 [get_ports hsync_signal]                                         
        set_property IOSTANDARD LVCMOS33 [get_ports hsync_signal]
set_property PACKAGE_PIN R19 [get_ports vsync_signal]                                         
        set_property IOSTANDARD LVCMOS33 [get_ports vsync_signal]
